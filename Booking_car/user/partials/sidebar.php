    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="adminSidebar">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link" href="previewbook.php">🚗 การจองรถของฉัน</a></li>
                <li class="nav-item"><a class="nav-link" href="preview_approved.php">📋 สถานะรถโดยรวม</a></li>
            </ul>
            <span class="navbar-text">
            <?= htmlspecialchars($_SESSION['fullname']) ?>  | <a href="../index.php" >ออกจากระบบ</a>
            </span>
        </div>
    </div>
</nav>
